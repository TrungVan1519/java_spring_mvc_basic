	...
	<table class="table">
		...
		<tbody>
			<tr>
				...
				<th>${selectedStudent.country }</th>
				<th>
					<c:forEach items="${selectedStudent.programmingLanguage }" var="language">
						- ${language } <br>
					</c:forEach>
				</th>
				<th>${selectedStudent.about }</th>
				<th>${selectedStudent.acceptAgreement }</th>
			</tr>
		</tbody>
	</table>
